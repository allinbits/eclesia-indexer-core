 ...
 * typed handlers for module events without declaring anything themselves. The Cosmos block
 * events (block, begin_block, tx_events...) come from @eclesia/chain-cosmos. Declared here
 * rather than in an ambient .d.ts so it is emitted into the published declarations.
 */
declare global {
  interface EventMap extends AuthEvents, BankEvents, StakingEvents {
  }
}
